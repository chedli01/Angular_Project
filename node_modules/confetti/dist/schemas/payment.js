...
export const PaymentSchema = z.object({
    ...
    commission: decimalStringSchema().describe(JSON.stringify({
        label: 'Commission',
    })),
    commissionVat: decimalStringSchema().describe(JSON.stringify({
        label: 'Commission VAT',
    })),
    customer: z.looseObject({}).describe(JSON.stringify({
        label: 'Customer',
    })),
    ...
    paidAt: z.date().describe(JSON.stringify({
        label: 'Paid At',
    })),
});
