...
export const TicketBatchSchema = z.object({
    ...
    left: z.number().describe(JSON.stringify({
        label: 'Left',
    })),
    ...
    promoCode: z.string().describe(JSON.stringify({
        label: 'Promo code',
    })),
    releasedAt: z.date().describe(JSON.stringify({
        label: 'Released at',
    })),
    closedAt: z.date().describe(JSON.stringify({
        label: 'Closed at',
    })),
    price: z.string().describe(JSON.stringify({
        label: 'Price',
    })),
    useCustomVat: z.boolean().describe(JSON.stringify({
        label: 'Use custom VAT',
    })),
    vatPercentage: z.number().describe(JSON.stringify({
        label: 'VAT percentage',
    })),
    limit: z.number().describe(JSON.stringify({
        label: 'Limit',
    })),
    sold: z.number().describe(JSON.stringify({
        label: 'Sold',
    })),
    reserved: z.number().describe(JSON.stringify({
        label: 'Reserved',
    })),
    settings: z.looseObject({}).describe(JSON.stringify({
        label: 'Settings',
    })),
    ...
    linkedTicketBatchId: z.number().describe(JSON.stringify({
        label: 'Linked ticket batch Id',
    })),
    formId: z.number().describe(JSON.stringify({
        label: 'Form Id',
    })),
    payoutId: z.number().describe(JSON.stringify({
        label: 'Payout Id',
    })),
});
